document.addEventListener('DOMContentLoaded', () => {
  ...
  function revealSquare(square) {
    ...
    if (!square.classList.contains('boom')) {
      ...
      if (square.classList.contains('cruiser')) if(currentPlayer === true) {cruiserCount++}else{cpuCruiserCount++}
      if (square.classList.contains('battleship')) if(currentPlayer === true) {battleshipCount++}else{cpuBattleshipCount++}
      if (square.classList.contains('carrier')) if(currentPlayer === true) {carrierCount++}else{cpuCarrierCount++}
    }
